...
public class AppointmentController {
    ...
    public ResponseEntity<ApiResponse<AppointmentResponse>> deleteAppointment(
        ...
        Appointment removed = appointmentService.removeAppointment(appointment);
        return ResponseEntity.ok(ApiResponse.ok("Appointment cancelled", toResponse(removed)));
    }
    ...
    private AppointmentDetailResponse toDetailResponse(
        ...
        Set<com.capstone.healthcare.diagnostictest.dto.TestSearchResponse> tests = a.getDiagnosticTests().stream()
